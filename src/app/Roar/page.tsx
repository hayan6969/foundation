...
function page() {
  return (
    ...
    <div className=' flex  justify-between items-center w-screen px-20 max-md:px-10 max-sm:px-4 overflow-hidden max-md:hidden'>
      <div className='h-60 w-44  bg-slate-300 rounded-sm m-0'></div>
      <div className='h-60 w-44  bg-slate-300 rounded-sm mt-20 max-md:mt-0 mx-0'></div>
