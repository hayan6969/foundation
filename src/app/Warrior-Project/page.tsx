...
function Page() {
  return (
    <>
    <Header/>
    <section className='w-screen flex flex-col  items-center gap-8 px-20 max-md:px-10 max-sm:px-4 overflow-hidden text-black pt-20 pb-10 text-center'>
    ...
    <section className='w-screen flex flex-col gap-8 px-20 max-md:px-10 max-sm:px-4 overflow-hidden text-black pb-10'>
